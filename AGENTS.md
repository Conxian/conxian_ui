...
*   **Base Canvas (60%)**: Enforce an "Ivory" or warm off-white foundation (#FDFBF7) for all primary application backgrounds and operational zones.
...
*   **Contrast**: Ensure all text contrast ratios meet strict institutional accessibility standards (WCAG AAA for financial data, ~12:1 ratio).
